...
const TantoBushoSelect = (props: any) => {
  const {
    label,
    tantoBushoOptions,
    selectedTantoBushoOption,
    onTantoBushoChange,
    selectDisable,
    onDelete,
    deleteDisable,
  ...
  const handleTantoBushoChange = (dataChange: any) => {
    onTantoBushoChange(dataChange)
  }
        ...
        <StyledColNoPaddingRight>
          ...
          <StyledRowNoMargin>
            <StyledColNoPaddingLeft>
              <SelectBox
                value={selectedTantoBushoOption}
                onChange={handleTantoBushoChange}
                options={tantoBushoOptions}
                isClearable
                isSearchable
                placeholder=""
...
export default TantoBushoSelect
